...
for i in range(1,num+1):
    print(f"El factorial de {i} = {factorial(i)}" )
...
def potencia(base, exponente):
    return 1 if exponente == 0 else potencia(base, exponente-1)*base
...
print(f"La suma de sus digitos es: {contar_bloques(n)}") 
...
numero = int(input("Ingresá un número entero positivo: "))
digito = int(input("Ingresá un digito: "))
print(f"La cantidad de digitos que se repiten: {contar_digito(numero, digito)}") 